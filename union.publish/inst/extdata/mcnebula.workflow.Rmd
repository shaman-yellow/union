...
bibliography: '`r system.file("extdata", "library.bib", package = "union.publish")`'
csl: '`r system.file("extdata", "styles.csl", package = "union.publish")`'
output:
...
file <- system.file("extdata", "workflow.png", package = "union.publish")
